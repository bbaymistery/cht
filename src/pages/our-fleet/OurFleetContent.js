  ...
  return (
      <div className="content-wrapper-outer clearfix">
          ...
          <div className="main-content main-content-full">
              ...
              <div className="fleet-block-wrapper fleet-2-cols clearfix">

                  {/* <!-- BEGIN .fleet-block --> */}
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/standard-saloon-op-2.png" alt="Saloon" /></a>
                      </div>
                  ...
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/estate-op-2.png" alt="Estate" /></a>
                      </div>
                      <div className="fleet-block-content">
                  ...
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/mpv-op-1.png" alt="MPV" /></a>
                      </div>
                      <div className="fleet-block-content">
                  ...
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/8-seater-op-1.png" alt="8 Seater" /></a>
                      </div>
                      <div className="fleet-block-content">
                  ...
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/executive_saloon.png" alt="Saloon VIP" /></a>
                      </div>
                      <div className="fleet-block-content">
                  ...
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/mpv-vip.png" alt="MPV VIP" /></a>
                      </div>
                      <div className="fleet-block-content">
                  ...
                  <div className="fleet-block">
                      <div className="fleet-block-image">
                          <a href="#"><img src="images/cars/8-seater-vip-op-1.png" alt="8 Seater VIP" /></a>
                      </div>
                      <div className="fleet-block-content">
...
export default OurFleetContent